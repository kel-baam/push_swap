...
SUB_BONUS=checker.c get_next_line.c get_next_line_utils.c helpers.c operators_a.c operators_a_b.c operators_b.c ft_lstadd_back_bonus.c error.c ft_lstadd_front_bonus.c ft_lstlast_bonus.c  stack.c ft_atoi.c ft_lstnew_bonus.c
