...
void	sort_three_numbers(t_list *stack_a)
{
	if (is_sort(stack_a))
		return ;
	if (stack_a->content > stack_a->next->content
		&& stack_a->next->content > ft_lstlast(stack_a, 0)->content)
	{
		sa(stack_a,1);
		rra(stack_a,1);
	}
	else if (stack_a->content > stack_a->next->content && ft_lstlast(stack_a,
			0)->content < stack_a->content)
		ra(stack_a,1);
	else if (stack_a->content > stack_a->next->content
		&& stack_a->content < ft_lstlast(stack_a, 0)->content)
		sa(stack_a,1);
	else if (stack_a->content < stack_a->next->content && ft_lstlast(stack_a,
			0)->content < stack_a->content)
		rra(stack_a,1);
